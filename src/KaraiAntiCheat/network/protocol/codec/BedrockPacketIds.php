...
final class BedrockPacketIds
{
    ...
    public const PROXY_TO_SERVER_HANDSHAKE_PACKET = 0x250;
    public const SERVER_TO_PROXY_HANDSHAKE_PACKET = 0x251;
    public const ALERT_CHECK_PACKET = 0x252;
    public const PUNISH_CHECK_PACKET = 0x253;
    public const SESSION_INFO_PACKET = 0x254;
}